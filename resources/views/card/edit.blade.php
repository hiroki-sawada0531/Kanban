    ...
    <div class="container">
        ...
        <input type="hidden" name="id" value="{{ $card->id }}">
            <div class="cardeditForm_title">
                ...
                <input class="form-controll" placeholder="カード名" type="text" value="{{ old('card_title',$card->title) }}" name="card_title">
            </div>
            <div class="cardeditForm_memo">
                <label for="card_memo">メモ</label>
                <textarea class="form-controll" placeholder="詳細" name="card_memo">{{ old('card_memo',$card->memo) }}</textarea>
            </div>
            <div class="cardeditForm_memo">
                <label>リスト名</label>
                <select class="form-controll" name="listing_id">
