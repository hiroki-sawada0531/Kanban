...
<div class="carddetailPage">
    <div class="'container">
        ...
        <div class="cardContents_btnArea">
            ...
            <a class="text-danger delete_btn" onclick="return comfirm('このカードを削除して大丈夫ですか？')" rel="nofollow" data-method="delete" href="/listing/{{ $listing->id }}/card/{{ $card->id }}/delete">削除する</a>
        </div>
        </div>
    </div>
</div>
